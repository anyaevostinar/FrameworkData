...
cp /Accounts/USERNAME/FrameworkData/Data/26_7_13_StressSameSett/flat-reward-2-env.json .
cp /Accounts/USERNAME/FrameworkData/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 1 -STRESS_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json -HOST_REPRO_RES 2 -SYM_HORIZ_TRANS_RES 2 -HOST_ONLY_FIRST_TASK_CREDIT 0"
