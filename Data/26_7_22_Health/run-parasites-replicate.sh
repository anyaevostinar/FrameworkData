...
cp /Accounts/hillmane/FrameworkData/Data/26_7_22_Health/flat-reward-2-env.json .
cp /Accounts/hillmane/SymbulationEmp/symbulation_sgp .

args=" -START_MOI 1 -HEALTH_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json -HOST_REPRO_RES 2 -SYM_HORIZ_TRANS_RES 1 -HOST_ONLY_FIRST_TASK_CREDIT 0"
