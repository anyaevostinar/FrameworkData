...
#SBATCH --job-name=nnsf
#SBATCH -o nnsf%A_%a.out
...
cp /Accounts/hillmane/FrameworkData/Data/26_7_20_NutrientSameSett/flat-reward-2-env.json .
cp /Accounts/hillmane/FrameworkData/SymbulationEmp/symbulation_sgp .

args=" -START_MOI 0 -HEALTH_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json -HOST_REPRO_RES 3.5 -SYM_HORIZ_TRANS_RES 3.5 -HOST_ONLY_FIRST_TASK_CREDIT 0"
