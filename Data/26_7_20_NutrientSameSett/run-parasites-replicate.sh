...
args=" -START_MOI 1 -NUTRIENT_TYPE parasite -TASK_ENV_CFG_PATH flat-reward-2-env.json -HOST_REPRO_RES 3.5 -SYM_HORIZ_TRANS_RES 3.5 -HOST_ONLY_FIRST_TASK_CREDIT 0"
