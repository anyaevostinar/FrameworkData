...
cd /Accounts/USERNAME/FrameworkData/Data/26_7_13_HealthSameSett
...
cp /Accounts/USERNAME/FrameworkData/Data/26_7_13_HealthSameSett/SymSettings.cfg .
cp /Accounts/USERNAME/FrameworkData/Data/26_7_13_HealthSameSett/diff-reward-env.json .
cp /Accounts/USERNAME/FrameworkData/SymbulationEmp/symbulation_sgp .

args=" -START_MOI 1 -VERTICAL_TRANSMISSION 1 -HEALTH_TYPE mutualist -TASK_ENV_CFG_PATH diff-reward-env.json -HOST_REPRO_RES 256 -SYM_HORIZ_TRANS_RES 128 -HOST_MIN_CYCLES_BEFORE_REPRO 0 -SYM_MIN_CYCLES_BEFORE_REPRO 0 -HOST_ONLY_FIRST_TASK_CREDIT 1"
