...
args=" -START_MOI 1 -VERTICAL_TRANSMISSION 1 -ENABLE_HEALTH true -HEALTH_TYPE mutualist -TASK_ENV_CFG_PATH diff-reward-env.json -HOST_REPRO_RES 256 -SYM_HORIZ_TRANS_RES 128"
